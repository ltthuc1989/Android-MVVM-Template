...
/**
 * A [ViewModelProvider.Factory] subclass that receives initView map of ViewModel classes and their providers,
 * and responsible for creating and holding each ViewModel based on their classes
 *
 * @param creators initView [Map] of ViewModel classes and their providers
 */
@Singleton

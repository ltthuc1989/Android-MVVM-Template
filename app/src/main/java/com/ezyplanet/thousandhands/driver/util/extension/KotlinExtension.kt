package com.ezyplanet.thousandhands.driver.util.extension
...
import com.ezyplanet.thousandhands.core.util.extension.inTransaction
...
fun EditText.selectAll(){
    setSelection(0,text.toString().length-1)
}
...
inline fun <F> AppCompatActivity.replaceMapFragment(fragment: F) where F : SupportMapFragment {
